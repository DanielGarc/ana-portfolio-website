    ...
    <div className="fitStudyWrapper">
      ...
      <div className="sectionOne">
        <div className="overview">
          ...
          <p>
            Fitness instructors have a lot to work on, not just classes but,
            working with people, with their goals, not only changing their body
            but their minds. This is hard to do when you have to write
      ...
      <div className="firstData">
        ...
        <p style={{ width: "80%" }}>
          ...
          did I gather information? Great question! I did the following
        </p>
      ...
      <div className="targetSection">
        ...
        <div className="targetReady">
          ...
          <p>
            By doing the previous I got a more define idea of the main targets,
            it also helped me to always keep in mind the user’s needs and goals.
            Whenever I got stuck in the user flow I always went back and re-read
            it.
          </p>
          <p>
      ...
      <div className="workshop">
        ...
        <p>
          ...
          with some exercises because I wanted to know how they would tackle the
          problems in their own way. I explained the purpose of this app, the
          challenge and lay down the problems found in our target audience. I
          wrote down the problems on top of the board so everyone could have a
          vision of the problems and started generating ideas, after a couple of
          minutes we stop and did dot voting.
        </p>
        <p>
        ...
        <p>
          <i>
            <b>
              4. “Okay, based on that market analysis, I’m adding that feature”
