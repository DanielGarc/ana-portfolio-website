    ...
    <>
        ...
        <div className="col-container width-2 sx-margin">
          <div className="col user-disc-text left">
            ...
            <p>
              ...
              consider more aspects that we didn’t think of in the beginning. We
              didn’t just need to give the optimal price, the users wanted
              something manageable, something that will tell them when the high
              seasons are, and how they should price their Airbnb based on those
              amenities.
            </p>
          </div>
          <div className="col">
      ...
      <Section sectionColor="#fffafa" wrapperColor="#fffafa" align={"center"}>
        ...
        <div className="col-container width-2">
          ...
          <div className="col unexp-data-text">
            ...
            <h3>
              The hosts want to know what their guests want...
              <i>sound familiar? </i>
            </h3>
            <p>
              ...
              <br />
              <br />
              We created another survey and sent it to all the people who had
              used Airbnb before. The results were quite simple. While the
              reason for the visits varied from guest to guest, guests are
              willing to pay more, on average, for a clean apartment with all
              the amenities.
            </p>
          </div>
        </div>
      ...
      <Section sectionColor="#fffafa" wrapperColor="#fffafa" align={"center"}>
        ...
        <div className="col-container width-2">
          ...
          <div className="col brainstorming-img">
            <div className="brainstorming-right left">
              ...
              <div className="section-spacer" />
              <p>
                Like you see below, we created a board with each problem and
                each member of the group wrote a possible solution. Everyone was
                encouraged to write an idea, even if they thought was dumb or
                silly.
                <br />
                <br />
                After each person wrote their ideas, we all voted on the top 3
                post-it ideas for each problem. Later we debated and discussed
                which of the problems were possible to build within our
                timeframe.
              </p>
            </div>
          </div>
        ...
        <div className="width-1 left sx-margin">
          ...
          <p>
            While reviewing the ideas, we started sketching to create a ‘perfect
            flow’ that felt more harmonious. Everyone was so enthusiastic about
            the solutions that we created different scenarios in which users
            would take different routes. In the end, we selected the best
            suitable solutions for our timeframe.
          </p>
        </div>
        <div className="section-spacer" />
        ...
        <div className="width-1 left sx-margin">
          ...
          <p>
            We followed the steps. We did everything right and created a low
            fidelity flow and tested it with the users. They were excited and
            gave us such positive feedback but… PIVOT! Our Data Scientist
        ...
        <div className="width-1 left sx-margin">
          ...
          <p>
            We conducted a couple of A/B tests to have a better idea of what UI
            was better for our audience. In the beginning, it was pretty close
            but then there was a huge difference. We decided to go for a look
      ...
      <div className="special-section">
        <div className="col-container  width-2 sx-margin">
          ...
          <div className="col">
            <img src={UI1} alt="Final UI 1" style={{ maxWidth: "100%" }} />
          </div>
        </div>
      </div>
      ...
      <Section sectionColor="#fffafa" wrapperColor="#fffafa">
        <div className="width-1 left sx-margin">
          ...
          <p>
            ...
            feedback on what else they would like to see in future releases. For
            example, they were happy with the comparison but they would like to
            see a quick view of the listing that it is being compared to.
          </p>
        </div>
      </Section>
      <div className="section-spacer" />
      ...
      <Section wrapperColor="#FFE5E5" sectionColor="#FFE5E5">
        ...
        <div className="col-container  width-2 section-half-space">
          <div className="col">
            ...
            <div className="section-half-space" />
            <img src={Hifi2} alt="Hi Fi Listing" style={{ maxWidth: "100%" }} />
          </div>
          <div className="col-divider "></div>
          <div className="col">
            <div>
